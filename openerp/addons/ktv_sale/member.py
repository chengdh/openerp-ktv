...
class member(osv.osv):
    ...
    _columns ={
            ...
            "make_fee" : fields.float("make_fee",digits =  (2,10),help = "制卡费用,默认取会员等级中的制卡费用"),
            "valid_date" : fields.date("valid_date",help="卡有效期",required = True),
            "overdraft_fee" : fields.float("overdraft_fee",digits = (2,10),help="可透支额度"),
